...
parser.add_argument('--data', type=str, default='nasdaq100_padding.csv',
...
def adjust_learning_rate(net, n_iter):
...
raw_data = pd.read_csv(os.path.join("data", args.data), nrows=100 if debug else None)
